...
var antiwame = JSON.parse(fs.readFileSync('./storage/antiwame.json'))
var nsfww = JSON.parse(fs.readFileSync('./storage/nsfww.json'))
//━━━━━━━━━━━━━━━[ SETTING ]━━━━━━━━━━━━━━━━━//
...
var num = "62895606093746@s.whatsapp.net"
var ownerNumber = ["62895606093746@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
...
var isAntiWame = isGroup ? antiwame.includes(from) : false
...
status: 1,
surface : 1,
message: `BOT BY AYYON`,
orderTitle: `BOT BY AYYON`,
thumbnail: fakethumb,
...
sendButLocation(from, menu, "©Created By Ayyon", fakeimg, but, zer)
break
case 'downloadmenu':
menu = `❏ 「 \`\`\`DOWNLOAD MENU\`\`\` 」
➤ ${prefix}infogempa
...
◉ ${prefix}storyanime
◪ Runtime : ${runtime(process.uptime())}
◪  妹Nem-Kun@^3.0.0`, locationMessage: locatione,
buttons: buttons,
headerType: 6
}
...
if (!isBotGroupAdmins) return reply(mess.only.bodmin)
if (args[0] == "on") {
if (isAntilink) return reply("𝐒𝐮𝐝𝐚𝐡 𝐀��𝐭��𝐟 𝐒𝐞𝐛𝐞𝐥𝐮𝐦𝐧𝐲𝐚...!!!");
antilink.push(from);
fs.writeFileSync(
"./storage/antilink.json",
JSON.stringify(antilink)
);
reply("��𝐮��𝐬��𝐬 𝐌𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐀��𝐭��𝐥��𝐧��");
} else if (args[0] == "off") {
...
if (!isBotGroupAdmins) return reply(mess.only.bodmin)
if (args[0] == "on") {
if (isAntivirtex) return reply("𝐒𝐮𝐝𝐚𝐡 ��𝐤��𝐢�� 𝐒𝐞𝐛𝐞𝐥𝐮𝐦𝐧𝐲𝐚...!!!");
antivirtex.push(from);
fs.writeFileSync(
"./storage/antivirtex.json",
JSON.stringify(antivirtex)
);
reply("��𝐮��𝐬��𝐬 𝐌𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐀��𝐭��𝐯��𝐫��𝐞��");
} else if (args[0] == "off") {
...
reply("��𝐮��𝐬��𝐬 𝐌𝐞𝐦𝐚𝐭𝐢𝐤𝐚𝐧 ��𝐧��𝐢��𝐢��𝐭��𝐱");
} else if (!q) {
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.bodmin)
reply(`\`\`\`𝐒��𝐤��𝐞�� 𝐌𝐞𝐦𝐛𝐮𝐤𝐚 𝐆��𝐨��𝐩\`\`\` *${groupMetadata.subject}*`)
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.bodmin)
reply(`\`\`\`𝐒��𝐤��𝐞�� 𝐌𝐞𝐧𝐮𝐭𝐮𝐩 𝐆��𝐨��𝐩\`\`\` *${groupMetadata.subject}*`)
...
teks = '𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 𝐃�� 𝐓𝐞𝐫𝐢𝐦𝐚, 𝐊𝐚𝐦𝐮 𝐌��𝐧��𝐚��𝐢 𝐀𝐝𝐦𝐢𝐧 :\n'
...
mentions(`𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 ��𝐢 𝐓𝐞𝐫𝐢𝐦𝐚, @${mentioned[0].split('@')[0]} 𝐊��𝐦�� 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 𝐀��𝐦��𝐧 𝐃𝐢 𝐆��𝐨��𝐩 *${groupMetadata.subject}*`, mentioned, true)
zero.groupMakeAdmin(from, mentioned)
}
break
case 'demote' :
...
mentioned = zer.message.extendedTextMessage.contextInfo.mentionedJid
if (mentioned.length > 1) {
teks = '𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 𝐃�� 𝐓𝐞𝐫𝐢𝐦𝐚, 𝐊𝐚𝐦𝐮 𝐓��𝐝��𝐤 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 ��𝐝��𝐢�� 𝐋𝐚𝐠𝐢 :\n'
for (let _ of mentioned) {
teks += `@${_.split('@')[0]}\n`
}
mentions(teks, mentioned, true)
...
mentions(`𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 ��𝐢 𝐓𝐞𝐫𝐢𝐦𝐚, 𝐌𝐞𝐧𝐮𝐫𝐮𝐧𝐤𝐚𝐧 : @${mentioned[0].split('@')[0]} 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 ��𝐞��𝐛��𝐫`, mentioned, true)
zero.groupDemoteAdmin(from, mentioned)
}
break
case 'add':
...
console.log('Error :', e)
reply('��𝐚��𝐚�� 𝐌𝐞𝐧𝐚𝐦𝐛𝐚𝐡𝐤𝐚𝐧 𝐓��𝐫��𝐞��, ��𝐮��𝐠��𝐢�� 𝐊𝐚𝐫𝐞𝐧𝐚 ��𝐢 𝐏𝐫𝐢𝐯𝐚𝐭𝐞!')
}
break
case 'kick':
if (!isGroup) return reply(mess.only.group)
...
zero.sendMessage(from, `\`\`\`𝐒𝐮𝐤𝐬𝐞𝐬 ��𝐞��𝐠��𝐚��𝐭�� 𝐍𝐚𝐦𝐚 ��𝐫��𝐮�� 𝐌𝐞𝐧𝐣𝐚𝐝??\`\`\` *${body.slice(9)}*`, text, { quoted: ftrol })
break
case 'setdesc':
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return reply(mess.only.admin)
...
zero.sendMessage(from, `\`\`\𝐒��𝐤��𝐞�� 𝐌𝐞𝐧𝐠𝐠𝐚𝐧𝐭𝐢 𝐃��𝐬��𝐫��𝐩��𝐢 𝐆𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}* Menjadi: *${body.slice(9)}*`, text, { quoted: ftrol })
break
case 'hidetag':
...
reply(mess.wait)
reply(`\`\`\`𝐒��𝐤��𝐞�� 𝐌𝐞𝐧𝐠𝐠𝐚𝐧𝐭𝐢 𝐏��𝐨��𝐢�� 𝐆𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
break
case 'bc':
case 'bcbut':
...
buttonsMessage = {footerText:'GWS:V', imageMessage: imageMsg,
contentText:`Ayyon`,buttons,headerType:4}
prep = await zero.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
zero.relayWAMessage(prep)
...
break
case 'anjing':
buff = await getBuffer(`https://api.lolhuman.xyz/api/sticker/${command}?apikey=KontoleBaperan`)
...
buttonsMessage = {footerText:'妹Nem-Kun@^3.0.0', imageMessage: imageMsg,
...
costum(buffer, sticker, Verived, `𝐉𝐚𝐧𝐠𝐚𝐧 ��𝐮��𝐚 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ��𝐞��𝐨 𝐘𝐓𝟕`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Makasih Ke Ayyon Ayyon`)
fs.unlinkSync(ran)
})
break
case 'owner':
...
await zero.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Makasih Ke Ayyon'})
break
case 'ytmp3':
if (args.length === 0) return reply(`Link Nya Mana ?\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
...
nsfww.push(from)
fs.writeFileSync('./storage/nsfww.json', JSON.stringify(nsfww))
reply('Sukses mengaktifkan fitur nsfw')
zero.sendMessage(from, `lanjut?`, text)
...
case 'codwarzone':
case 'valorantbanner':
if (args.length == 0) return reply(`Teks Nya Mana ?\nContoh : ${prefix + command} Ayyon`)
bo = args.join(" ")
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=${apikey1}&text=${bo}`)
zero.sendMessage(from, anu, image, {quoted: ftrol, caption: 'Done Makasih Ke Ayyon Ayyon' })
break
case 'hartatahta':
case 'naruto':
case 'bneon':
...
zero.sendMessage(from, res, image, {quoted: ftrol, caption: 'Done Makasih Ke Ayyon Ayyon' })
break
case 'wolflogo':
case 'pubglogo':
case 'snowwrite':
...
zero.sendMessage(from, wll, image, {quoted: ftrol, caption: 'Done Makasih Ke Ayyon Ayyon' })
break
case 'blackpink':
case 'neon':
case 'greenneon':
...
zero.sendMessage(from, blck, image, {quoted: ftrol, caption: 'Done Makasih Ke Ayyon Ayyon' })
break
case 'ssweb':
...
zero.sendMessage(from, hasil, image, { thumbnail: Buffer.alloc(0), caption: `Done Makasih Ke Ayyon Ayyon`, quoted : ftrol})
})
break
case 'asupan':
...
zero.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Makasih Ke Ayyon'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${apikey5}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zero.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Makasih Ke Ayyon'})
break
case 'asupanhijaber':
